...
# Diperbarui agar depresiasi NT dan lonjakan ICP BERDAMPAK NEGATIF pada PDB
EL = {
    ...
    "gexp_nt":         -0.08,  "gimp_nt":          0.06,    # INVERTED: PDB Turun saat Rupiah melemah
    "gexp_oil":        -0.025, "gimp_oil":        -0.018,   # INVERTED: PDB Turun saat ICP naik
...
# ===============================================================================
# FUNGSI SIMULASI (Sama 1:1, hanya efek koefisien `EL` di atas yang bekerja)
# ===============================================================================
...
# =========================================================================
    ...
    with tab_gdp:
        ...
        with col_nt:
            ...
            st.caption("Elastisitas sudah disesuaikan agar pelemahan NT berdampak negatif ke PDB.")
        ...
        with col_icp:
            ...
            st.caption("Elastisitas sudah disesuaikan agar lonjakan ICP berdampak negatif ke PDB.")
